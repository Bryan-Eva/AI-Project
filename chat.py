...
class chat:
    def __init__(self, config):
        ...
        self.context = [
            "Assuming you are an expert in smart factory, software and operations communications"
        ]
        self.index = 1
    ...
    def ask(self, input_text):
        ...
        print(f"第{self.index}次訪問結束: 耗時 hh:mm:ss:fff ={td}")
...
if __name__ == "__main__":
    ...
    while input_text.lower() != "-1":
        result = chat_instance.ask(input_text)
